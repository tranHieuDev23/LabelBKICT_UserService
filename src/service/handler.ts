...
import { UserPasswordManagementOperator, USER_PASSWORD_MANAGEMENT_OPERATOR_TOKEN } from "../module/password";
import { UserPermissionManagementOperator, USER_PERMISSION_MANAGEMENT_OPERATOR_TOKEN } from "../module/permission";
import { UserRoleManagementOperator, USER_ROLE_MANAGEMENT_OPERATOR_TOKEN } from "../module/role";
...
import { UserTagManagementOperator, USER_TAG_MANAGEMENT_OPERATOR_TOKEN } from "../module/tag";
    ...
    public getUserServiceHandlers(): UserServiceHandlers {
        const handler: UserServiceHandlers = {
            ...
            UpdateUser: async (call, callback) => {
                ...
                try {
                    const updatedUser = await this.userManagementOperator.updateUser(req.user);
            ...
            SearchUser: async (call, callback) => {
                ...
                try {
                    const userList = await this.userManagementOperator.searchUser(req.query, limit, includedUserIdList);
            ...
            LoginWithPassword: async (call, callback) => {
                ...
                try {
                    const { user, token } = await this.userPasswordManagementOperator.loginWithPassword(
                        req.username,
                        req.password
                    );
            ...
            CreateUserRole: async (call, callback) => {
                ...
                try {
                    const createdUserRole = await this.userRoleManagementOperator.createUserRole(
                        req.displayName,
                        req.description
                    );
            ...
            GetUserRoleList: async (call, callback) => {
                ...
                try {
                    const { totalUserRoleCount, userRoleList } = await this.userRoleManagementOperator.getUserRoleList(
                        req.offset,
                        req.limit,
                        req.sortOrder
                    );
            ...
            GetUserRoleListOfUserList: async (call, callback) => {
                ...
                try {
                    const userRoleListOfUserList = await this.userRoleManagementOperator.getUserRoleListFromUserList(
                        req.userIdList
                    );
            ...
            UpdateUserPermission: async (call, callback) => {
                ...
                try {
                    const updatedUserPermission = await this.userPermissionManagementOperator.updateUserPermission(
                        req.userPermission
                    );
                    return callback(null, {
            ...
            GetUserPermissionListOfUserRoleList: async (call, callback) => {
                ...
                try {
                    ...
                    return callback(null, {
                        userPermissionListOfUserRoleList: userPermissionListProtoList,
                    });
                } catch (e) {
                    this.handleError(e, callback);
                }
            ...
            GetUserPermissionListOfUser: async (call, callback) => {
                ...
                try {
                    const userPermissionList = await this.userPermissionManagementOperator.getUserPermissionListOfUser(
                        req.userId
                    );
            ...
            CreateUserTag: async (call, callback) => {
                ...
                try {
                    const createdUserTag = await this.userTagManagementOperator.createUserTag(
                        req.displayName,
                        req.description
                    );
            ...
            UpdateUserTag: async (call, callback) => {
                ...
                try {
                    const updatedUserTag = await this.userTagManagementOperator.updateUserTag(req.userTag);
            ...
            DeleteUserTag: async (call, callback) => {
                ...
                try {
                    await this.userTagManagementOperator.deleteUserTag(req.id);
                    return callback(null, {});
                } catch (e) {
                    this.handleError(e, callback);
                }
            ...
            GetUserTagList: async (call, callback) => {
                ...
                try {
                    const { totalUserTagCount, userTagList } = await this.userTagManagementOperator.getUserTagList(
                        req.offset,
                        req.limit,
                        req.sortOrder
                    );
            ...
            AddUserTagToUser: async (call, callback) => {
                ...
                try {
                    await this.userTagManagementOperator.addUserTagToUser(req.userId, req.userTagId);
                    return callback(null, {});
                } catch (e) {
                    this.handleError(e, callback);
                }
            ...
            RemoveUserTagFromUser: async (call, callback) => {
                ...
                try {
                    await this.userTagManagementOperator.removeUserTagFromUser(req.userId, req.userTagId);
                    return callback(null, {});
                } catch (e) {
                    this.handleError(e, callback);
                }
            ...
            GetUserTagListOfUser: async (call, callback) => {
                ...
                try {
                    const userTagList = await this.userTagManagementOperator.getUserTagListOfUser(req.userId);
            ...
            GetUserTagListOfUserList: async (call, callback) => {
                ...
                try {
                    const userTagListOfUserList = await this.userTagManagementOperator.getUserTagListOfUserList(
                        req.userIdList
                    );
                    const userTagListProtoList = userTagListOfUserList.map((userTagList) => {
            ...
            GetUserListOfUserTagByDisplayName: async (call, callback) => {
                const req = call.request;
                if (req.displayName === undefined) {
                    return callback({
                        message: "display_name is required",
                ...
                try {
                    const userList = await this.userTagManagementOperator.getUserListOfUserTagByDisplayName(
                        req.displayName
                    );
