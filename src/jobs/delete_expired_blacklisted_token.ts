...
export class DeleteExpiredBlacklistedTokenJobImpl
    implements DeleteExpiredBlacklistedTokenJob
{
    constructor(
    ...
    public async execute(): Promise<void> {
        await this.tokenManagementOperator.deleteExpiredBlacklistedToken(
            Date.now()
        );
